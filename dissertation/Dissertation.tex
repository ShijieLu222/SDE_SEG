...
\item When combined with the full framework, the strongest configuration
  ...
  paper's multi-GPU result by $+0.18$\,pp, suggesting that the proposed 
  method remains competitive with the original multi-GPU result even 
  under more constrained hardware conditions.
